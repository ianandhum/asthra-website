...
|///|///////////////////////////////////////////////////////////|///|
|///|/  Tooltip plugin version 1.2.1  ///////                   |///|
|///|   The documentation is priorly  done by dwtooltip.com///  |///|
|///|   This script is developed by dyn-web.com/////            |///|
|///|   and modified by Anandhu manoj at Uniwing.in///          |///|
|///|///////////////////////////////////////////////////////////|///|
*/
var dw_Event={
	...
	DOMit:function(e){
		...
		if(!e.target)
			...
			if(!e.stopPropagation)
				e.stopPropagation=function(){e.cancelBubble=true;};return e;
		},
...
var dw_Viewport={
	getWinWidth:function()
		...
		if(window.innerWidth)
			...
			this.width=document.body.clientWidth;return this.width;
		},
	getWinHeight:function()
		...
		if(window.innerHeight)
			...
			this.height=document.body.clientHeight;return this.height;
		},
	getScrollX:function()
		{
		this.scrollX=0;
		if(typeof window.pageXOffset=="number")
			...
			this.scrollX=window.scrollX;return this.scrollX;
		},
	getScrollY:function()
		{
		this.scrollY=0;
		if(typeof window.pageYOffset=="number")
			...
			this.scrollY=window.scrollY;return this.scrollY;
		},
	getAll:function()
		{
		this.getWinWidth();
...
dw_Util.getCurrentStyle=function(el,prop){
	...
	if(document.defaultView&&document.defaultView.getComputedStyle){
		...
		if(!/^\d+(px)?$/i.test(val)&&/^\d/.test(val)){
			...
			el.style.left=val||0;val=el.style.pixelLeft+"px";
			el.style.left=style;
...
var dw_Tooltip={
	...
	positionRelEvent:function(e,tgt){
		...
		if(typeof e=='object'){
			if(e.type=='mouseover'||e.type=='mousemove'||e.type=='click'){
				_this.evX=_this.getMouseEventX(e);_this.evY=_this.getMouseEventY(e);
				if(e.type=='click'){
	...
	adjust:function(){
		...
		var img=imgs.length?imgs[imgs.length-1]:null;checkComplete();
