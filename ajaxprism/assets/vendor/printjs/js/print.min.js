! function(e, t) {
	...
	return function(e) {
		...
		function r(e, t) {
			...
			if (n.getComputedStyle) {
				...
				for (var d = 0; d < i.length; d++)
					for (var l = 0; l < r.length; l++) - 1 === i[d].indexOf(r[l]) && -1 === a.indexOf(i[d]) || (o += i[d] + ":" + i.getPropertyValue(i[d]) + ";")
		...
		function i(e) {
			...
			for (var a = 0; a < i.length; a++) r += '<div style="flex:1; padding:5px;' + e.gridHeaderStyle + '">' + n.i(o.b)(i[a].displayName || i[a]) + "</div>";
			r += "</div>";
			for (var d = 0; d < t.length; d++) {
				r += '<div style="flex:1 1 auto; display:flex;">';
				for (var
						l = 0; l < i.length; l++) r += '<div style="flex:1; padding:5px;' + e.gridStyle + '">' + t[d][i[l].field || i[l]] + "</div>";
				r += "</div>"
			}
			return r += "</div>"
		}
