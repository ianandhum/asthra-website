...
class ErrorMsg{
	...
	private  $errorMsg=array(
						...
						"EUTYPE"=>"User type is not identified",
						"EPERMISSION"=>"Not enough permissions to perform this operation",
						"ECONN"=>"Internal server error occured",
						"EBPASS"=>"Bad password",
						"EBUNAME"=>"BAD user name",
						"EBEMAIL"=>"Email address is not recognised",
						"ERUEMAIL"=>"This e-mail address is already registered",
						"ERUNAME"=>"This user name is already taken",
						"ETOKEN"=>"Token Mismatch",
						"EID"=>"Unable to identify the user",
						"EMAILER"=>"Could not sent mail",
						"EEVENT"=>"There is no such event",
						"EPHONE"=>"Invalid phone number",
						"ECOLLEGE"=>"Invalid college Name"
						);
