...
define('SERVER', '.mesasthra.com');


//server host
define("SERVER_HOST","http://".$_SERVER['HTTP_HOST']."/");

define('SERVER_HOME',"http://www.mesasthra.com/home/");

//mysql host name
define("DB_HOST_NAME","localhost");

//mysql user name
define("USER_DB_USER_NAME","l845jjulnu5p");

//mysql user password
define("USER_DB_USER_PASSWORD","Dipin@10");
...
define("HOST_MAILER_MAIL_ID","no-reply@mesasthra.com");
